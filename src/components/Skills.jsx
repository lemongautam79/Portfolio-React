            ...
            <section class="clients" id=" section_5">
                <div class="container">
                    <div data-aos="fade-up" data-aos-offset="500" data-aos-duration="700" class="row align-items-center ">
                        ...
                        <div data-aos="fade-up" data-aos-offset="500" data-aos-duration="700" class="col-lg-2 col-4 ms-auto clients-item-height">
                            <img src="https://img.icons8.com/color/240/null/javascript--v1.png" class="clients-image img-fluid" alt="jsimage" loading="lazy" />
                        </div>

                        <div data-aos="fade-up" data-aos-offset="500" data-aos-duration="700" class="col-lg-2 col-4 clients-item-height">
                        ...
                        <div data-aos="fade-up" data-aos-offset="500" data-aos-duration="700" class="col-lg-2 col-4 me-auto clients-item-height">
